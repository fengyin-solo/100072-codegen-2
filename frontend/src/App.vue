      ...
      <header class="app-head">
        ...
        <span class="head-user">
          ...
          <select class="operator-select" :value="store.operator" @change="switchOperator">
            <option v-for="person in store.personnel" :key="person" :value="person">{{ person }}</option>
          </select>
          · {{ store.shiftLabel }}
        </span>
      </header>
